...
def write_summary_comparisons(writer, comparisons):
    ...
    writer.write_data_frame(storage_by_cat, COMPARISONS_SHEET, STORAGE_CAT_INDEX, 'Storage by Category')
    writer.write_data_frame(storage_by_group, COMPARISONS_SHEET, STORAGE_GROUP_INDEX, 'Storage by Group')
    writer.write_data_frame(compute, COMPARISONS_SHEET, SERVICE_INDEX, 'Compute Comparison')
